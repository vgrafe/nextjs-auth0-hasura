...
// https://github.com/apollographql/apollo-client/issues/4190
import nextCookie from 'next-cookies'; // TODO remove when cookie solution found
...
function createApolloClient(initialState = {}) {
  ...
  const token = process.browser // TODO remove when cookie solution found
    ? cookie.get('token') // TODO remove when cookie solution found
    : nextCookie(ctx).token; // TODO remove when cookie solution found
